"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\kwlad\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.404\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '20a7683a7e9d4a188bf753UAYYCB1UDQMABQJTAF1bBlJUV1ID', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/kwlad/.vscode/extensions/wallabyjs.console-ninja-1.0.404/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20a7683a7e9d4a188bf753UAYYCB1UDQMABQJTAF1bBlJUV1ID', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
